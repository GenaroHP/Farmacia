...
<body>
 ...
 <section id="contact" class="contact">
      <div class="container">
        ...
        <br>
          <h2>Contacto</h2>
          <p>Ingrese sus datos para poder brindarle Información</p>
        </div>
      </div>
      <div class="container">
        <div class="row mt-5">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              Jhon G <br>
              Andahuaylas, San Jeronimo<br>
              Andahuaylas <br><br>
              <strong>Teléfono:</strong> +51 973169585<br>
              <strong>Correo:</strong>zjhony854@gmail.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Servicios de:</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Medicamentos</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Farmaceuticos</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Vitaminas</a></li>
            </ul>
          </div>
